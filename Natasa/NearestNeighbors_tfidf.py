...
knn_fitted = knn.fit(count_tfidf_todense)
indices_tfidf_new = knn.kneighbors(count_tfidf_new_question_todense, return_distance=False)

print(f"The {k_neighbors} most similar questions according to KNN Ball Tree (tf-idf): ")
for question in range(0, k_neighbors):
    q = indices_tfidf_new[0][question]
